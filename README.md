...
| Performance (x100000)             | Time      |
| --------------------------------- | --------- |
| bool Method(float)                | 00.00353s |
| Func<float, bool> (Regular)       | 00.00349s |
| Func<float, bool> (Dynamic)       | 00.00351s |
| SerializedCallback<float, bool>   | 00.00688s |
